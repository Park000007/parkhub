local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Park000007/Park-Hub-v.2/refs/heads/main/V1"))()
...
_env.CodesRedeem = loadstring(game:HttpGet("loadstring(game:HttpGet("https://raw.githubusercontent.com/Park000007/Park-Hub-v.2/refs/heads/main/Blox%20Fruit.lua"))()
...
local _home = Window:MakeTab("Home") do
  local _info = _home:Section({["Title"] = "Information", ["Content"] = ""}) do
    Funcs:AddButton(_info, "Discord Invite", "Click to copy invite server", function()
      _setclipboard("https://discord.gg/DXqrRxf6zd")
    end)
...
local _seaevent = Window:MakeTab("Sea Event") do
  ...
  local _farmsea = _seaevent:Section({["Title"] = "Farming Sea", ["Content"] = ""}) do 
    ...
    Funcs:AddToggle(_farmsea, "No Clip Rock", "", false)
